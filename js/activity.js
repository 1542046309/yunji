...
$(function(){
	$('.acshop').click(function(){
		$('.acnav').slideToggle(1000);
	})
});

$(window).scroll(function(){
	if($(window).scrollTop() > 850){
		$('.classifybox').css('position','fixed')
		$('.classifybox').css('top','0')
		$('.classifybox').css('left','0')
		$('.aclogo1').css('display','block')
	}else{
		$('.classifybox').css('position','')
		$('.aclogo1').css('display','none')
	}
